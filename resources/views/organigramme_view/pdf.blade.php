...
<body>
  ...
  <table width="100%" style='border: 1px solid;'>
   ...
   <tr class="f1">
      <td class="logobloc" style=""> <img style='position: relative; top: 20px;margin: 0 auto;margin-top: 20px;margin-bottom: 20px;' class="logo_anp" src="{{ asset('assets/img/logo_m.png') }}" alt=""> </td>
